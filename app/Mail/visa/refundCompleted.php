...
class refundCompleted extends Mailable
{
    ...
    {
        return $this->subject('Tuition Fees Refund Confirmation  for '.$this->course_detail->name .' at '.$this->university_detail->name .' - applycourses.com')
                    ->markdown('emails.visa.refundCompleted');
    }
}
