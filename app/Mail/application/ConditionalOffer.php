...
class ConditionalOffer extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject("Conditional Offer Issued  for $course_name at $university_name - applycourses.com")
                    ->markdown('emails.application.conditionalOffer');
    }
}
