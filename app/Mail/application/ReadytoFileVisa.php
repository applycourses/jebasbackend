...
class ReadytoFileVisa extends Mailable
{
    ...
    public function build()
    {
      ...
      return $this->subject("Tuition Fees Payment Confirmation  for $course_name at $university_name - applycourses.com")
                  ->markdown('emails.application.ReadytoFileVisa');
