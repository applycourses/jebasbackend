...
class Withdrawn extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject("Offer Withdrawal Request Approved for $course_name at $university_name - applycourses.com")
                    ->markdown('emails.application.Withdrawn');
