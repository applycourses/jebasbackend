...
class AgentCourseApplied extends Model
{
    ...
    public static function course_removed($id){
        ...
        $response = AgentCourseApplied::find($id)->update($update_data);
       return $response;
    }
}
