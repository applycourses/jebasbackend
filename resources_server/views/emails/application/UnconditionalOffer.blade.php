...
This is in regard to your application for the {{ $course_details->name }}. We are happy to inform you that {{ $university_details->name }} has accepted your admission to this program and they have issued  an unconditional offer letter .
