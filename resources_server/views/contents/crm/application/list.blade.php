...
@section('title','Application List of the Student')
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($value->tution_fee == 0)
                                                <a href="#"  class="btn btn-xs btn-warning">Not Paid</a>
                                            @elseif($value->tution_fee == 1)
                                                <a href="#"  class="btn btn-xs btn-danger">Payment Requested</a>
                                            @elseif($value->tution_fee ==2)
                                                <a href="#"  class="btn btn-xs btn-success"> <i class="fa fa-check"></i>Paid</a>
                                            @else
                                                <h5><span class="label label-danger"><i class="fa fa-hand-paper-o"></i> Error</span></h5>
                                            @endif
                                        </td>
                                       ...
                                       {{-- <td>
                                            <a href="{{ route('application.show',$value->id) }}" data-toggle="tooltip" title="View" class="btn btn-xs btn-primary">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="" data-toggle="tooltip" title="Add" class="btn btn-xs btn-success">
