            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <a href="{{ url('/registration-form/step1/'.app('request')->input('student_id')).'?student_id='.app('request')->input('student_id') }}" class="edit"></a>
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <th>Full Address</th>
                                                                <td>{{ $data->step1['permanent_address'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>City</th>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $data->step2['secondary']['country'] }}</td>
                                                                <td>{{ $data->step2['secondary']['state'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Start Date</th>
                                                                <th>End Date</th>
                                                        ...
                                                        @if($data['step2']['hs_status'] == 1)
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $data->step2['higher_secondary']['country'] }}</td>
                                                                    <td>{{ $data->step2['higher_secondary']['state'] }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Start Date</th>
                                                                    <th>End Date</th>
                                                            ...
                                                            @foreach($data['step2']['diploma_edu'] as $key => $value)
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $data->step2['diploma_edu'][$key]['country'] }}</td>
                                                                        <td>{{ $data->step2['diploma_edu'][$key]['state'] }} </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Start Date</th>
                                                                        <th>End Date</th>
                                                ...
                                                <div class="clearfix">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if(strtolower($data->step3['disability']) == 'yes')
                                                                    <td> {{ $data->step3['disability_detail'] }}</td>
                                                                @endif
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                <td><i class="{{ in_array('selfFunded',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked'}}"></i>
                                                                    Self-Funded
                                                                </td>
                                                                <td>
                                                                    <i class="{{ in_array('parents',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }} "></i>
                                                                    Parents
                                                                </td>
                                                                <td>
                                                                    <i class="{{ in_array('bankLoan',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }}"></i> Bank Loan
                                                                </td>
                                                                <td><i class="{{ in_array('employer',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }}"></i> Employer</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <i class="{{ in_array('scholarship',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }}"></i>
                                                                    Scholarship
                                                                </td>
                                                                <td>
                                                                    <i class="{{ in_array('parentsInLaw',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }}"></i>
                                                                    Parents-In-Law
                                                                </td>
                                                                <td colspan="2">
                                                                    <i class="{{ in_array('otherRelative',$data['step3']['funds']) ? 'fa fa-check-square-o' : 'glyphicon glyphicon-unchecked' }}""></i> Other Relative(s)
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table class="table table-bordered">
