...
class UnconditionalOffer extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject("Unconditional Offer Issued  for $course_name at $university_name - applycourses.com")
                  ->markdown('emails.application.UnconditionalOffer');
    }
}
