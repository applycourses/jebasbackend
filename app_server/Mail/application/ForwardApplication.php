...
class ForwardApplication extends Mailable
{
    ...
    public function build()
    {
       ...
       $university_name = $this->university_details->name;
        return $this->subject("Application Forwarded for $course_name $university_name - applycourses.com")
                    ->markdown('emails.application.forwardApplication');
    }
}
