...
class RequestforPayment extends Mailable
{
    ...
    public function build()
    {
      ...
      return $this->subject("Request to pay Tution Fee for $course_name at $university_name- applycourses.com")
                  ->markdown('emails.application.RequestforPayment');
