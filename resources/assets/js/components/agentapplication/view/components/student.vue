        ...
        <h4 class="bold">Acceptance Letter
            <div class="pull-right">
                <button
                        ...
                        @click="AcceptanceLetterbuttonRequest('update',1)"
                >Request to Accept
                </button>
                <button
                        type="button"
                        ...
                        @click="AcceptanceLetterbuttonRequest('update',0)"
        ...
        methods:{
            ...
            showStudentDocument(){
               ...
               if(this.student_application_documents == ''){
                   axios.get('/api/agent-student-application-document-list-application-id', {
            ...
            studentPaymentStatus() {
                let vm = this;
                axios.get('/api/agent-student-payment-status-application-id', {
                    params:{id: vm.applicationId}
                })
                .then(response => {
            ...
            paymentStatusButton(type){
                let vm = this;
                if(confirm("Are you sure?")){
                    vm.updateStudentPaymentStatus(type);
                }
            },
            updateStudentPaymentStatus(type){
                ...
                {
                    let vm = this;
                    axios.post('/api/agent-student-payment-status-application-id-update', {
            ...
            AcceptanceLetterbuttonRequest(action,new_status = false){
            let vm = this;
                if(confirm("Are you sure?")){
                    vm.studentAcceptanceLetter(action,new_status);
                }
            },
            studentAcceptanceLetter(action,new_status = false){
                ...
                if(action == 'view'){
                    if(1){
                        axios.get('/api/agent-student-acceptance-letter-application-id', {
                            params:{ id: vm.applicationId }
                        })
                        .then(response => {
                    ...
                    axios.post('/api/agent-student-acceptance-letter-application-id-update', {
                        id        : this.applicationId,
            ...
            studentUpdate(action){
                ...
                if(action == 'view'){
                    ...
                    axios.post('/application/agent-update-student-status',this.student_update)
                    .then(response => {
                      console.log(response);
                        if(response.data.success){
            ...
            getApplicationStatus(){
                let vm = this;
                axios.get('/agentapplication/student/status/'+this.applicationId)
                .then(response => {
