...
Your Counsellor has shortlisted the <b>{{ $data['course_name'] }} </b> in <b>{{ $data['univ_name'] }}</b>. If you wish to proceed further with the particular course then kindly go through the document checklist. Once you are ready please confirm the campus and course from your account.
