                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body">
                             ...
                             {{ Form::model($data, ['route' => ['course-list.update', $data->id], 'method' => 'patch']) }}
                                <div class="row">
                                    <div class="col-md-12">
                                                        ...
                                                        <div class="clearfix pl-5">
                                                            <div class="col-md-12">
                                                                <label class="radio-inline  pl-0">
                                                                    <input type="radio" name="remove_shortlisted" value="yes">Yes
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="remove_shortlisted" value="no" checked>No
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </td>
