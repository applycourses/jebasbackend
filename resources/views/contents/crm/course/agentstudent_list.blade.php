                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <a href="{{ url('student?view=course_add&student_id='.app('request')->input('student_id')) }}" class="addNew"></a>
                                        ...
                                        @foreach($course_applieds as $key => $value)
                                            ...
                                            @elseif($value->status == 'withdrawn')
                                                <tr class="warning">
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/agentstudent?view=course_view&student_id='.$value->student_id.'&course_apply_id='.$value->id) }}" data-toggle="tooltip" title="View" class="btn btn-xs btn-primary">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                    <td>
