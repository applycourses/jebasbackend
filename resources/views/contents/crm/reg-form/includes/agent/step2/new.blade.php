                                    ...
                                    <div class="tabbable-bordered margin-bottom-15">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active row" id="step1">
                                                @if($data)
                                                    {{ Form::model($data, array('url' => 'agent-registration-form/step2/edit','id'=>'step2Form','method'=>'PUT')) }}
                                                @else
                                                    <form name="step_2" action="{{ URL('/agent-registration-form/step2')}}" method="post" id="step2Form">
                                                    {{ csrf_field() }}
                                                @endif
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="secondary[country]" required="1" id="sec_country" aria-required="true" class="form-control country">
                                                                                <?php 
                                                                                    foreach($countries AS $index=>$country){
                                                                                        ?>
                                                                                            <option <?php if($data['secondary']['country'] == $index){ echo 'selected'; } ?> value="<?php echo $index; ?>"><?php echo $country; ?></option>
                                                                                        <?php
                                                                                    }
                                                                                ?>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <label>State</label>
                                                                            <?php echo $data['secondary']['country']; ?>
                                                                            {{ Form::select('number',  getStateNamesWithCountryId($data['secondary']['country']), $data['secondary']['state'], ['class' => 'form-control','name' => 'secondary[state]','required' => true,'id' => 'sec_state']) }}
                                                                ...
                                                                <div id="hs_div" >
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label>State</label>
                                                                                {{ Form::select('number',getStateNamesWithCountryId($data['higher_secondary']['country'])  ,$data['higher_secondary']['state'], ['class' => 'form-control','name' => 'higher_secondary[state]','required' => true,'id' => 'hs_state']) }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                ...
                                                                @foreach($data['diploma_edu'] as $i => $value)
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label>State</label>
                                                                                {{ Form::select('number',getStateNamesWithCountryId($data['diploma_edu'][$i]['country'])  , $data['diploma_edu'][$i]['state'], ['class' => 'form-control hs ','name' => 'diploma_edu['.$i.'][state]','required' => true,'id' => 'ad_state']) }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                ...
                                                                @foreach($data['ug_edu'] as $i => $value)
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label>State</label>
                                                                                {{ Form::select('number',getStateNamesWithCountryId($data['ug_edu'][$i]['country'])  ,$data['ug_edu'][$i]['state'], ['class' => 'form-control hs ','name' => 'ug_edu['.$i.'][state]','required' => true,'id' => 'ad_state']) }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                    ...
                                                                    @foreach($data['pg_edu'] as $i => $value)
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-3">
                                                                                <div class="form-group">
                                                                                    <label>State</label>
                                                                                    {{ Form::select('number',getStateNamesWithCountryId($data['pg_edu'][$i]['country'])  , $data['pg_edu'][$i]['state'], ['class' => 'form-control hs ','name' => 'pg_edu['.$i.'][state]','required' => true,'id' => 'ad_state']) }}
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-3">
                                                                                <div class="form-group">
...
<script>
    ...
    function get_countries(){
        $.getJSON("/api/countries", function(response){ countries_option(response); });
    }
