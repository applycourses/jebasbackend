        ...
        $(document).on('change','#noOfDependants',function(){
            ...
            if( value  != 0) {
                ...
                for(var i = 1; i <= value; i++){
                    $('#specifyRelationDiv table tbody').append('<tr> <td>'+i+'</td> <td><input type="text" class="form-control" placeholder="ex. John Paul" name="depedents_name[]" required></td> <td><select name='depedents_relation[]' class='form-control' required><option value="">Choose Relationship:</option><option>Mother</option><option>Father</option><option>Spouse</option><option>Daughter</option><option>Son</option><option>Sister</option><option>Brother</option><option>Auntie</option><option>Uncle</option><option>Niece</option><option>Nephew</option><option>Cousin (female)</option><option>Cousin (male)</option><option>Grandmother</option><option>Grandfather</option><option>Granddaughter</option><option>Grandson</option><option>Stepsister</option><option>Stepbrother</option><option>Stepmother</option><option>Stepfather</option><option>Stepdaughter</option><option>Stepson</option><option>Sibling (gender neutral)</option><option>Parent (gender neutral)</option><option>Child (gender neutral)</option><option>Sibling of Parent (gender neutral)</option><option>Child of Sibling (gender neutral)</option><option>Cousin (gender neutral)</option><option>Grandparent (gender neutral)</option><option>Grandchild (gender neutral)</option><option>Step-sibling (gender neutral)</option><option>Step-parent (gender neutral)</option><option>Stepchild (gender neutral)</option><option>Other</option> </select></td><td><select class='form-control' name='depedents_take[]' required><option value=''>Select Option</option><option value='1'>Yes</option><option value='0'>No</option> </select></td> </tr>')
                }
            }
        });
