                                    ...
                                    <div class="tabbable-bordered margin-bottom-15">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active " id="step1">
                                                <form name="step_2" action="/agent-registration-form/step3" method="post" id="Step3Form" >
                                                    {{ csrf_field() }}
                                                                    ...
                                                                    <div class="row mb-20">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                ?>
                                                                             <select name="employment[{{$key}}][country]" id="sec_country" class="form-control country">
                                                                                 <option value="">Select Option</option>
                                                                                 <?php 
                                                                                    foreach($countries AS $ckey=>$country){
                                                                                        ?>
                                                                                        <option <?php if($mycountry == $ckey){ echo "selected"; }  ?> value="{{ $ckey }}">{{ $country }}</option>
                                                                                        <?php
                                                                                    }
                                                                                 ?>
                                                                             </select>
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                                <label>State</label>           
                                                                                {{ Form::select('number',getState($mycountry)  , $value['state'], ['class' => 'form-control','name' => 'employment['.$key.'][state]','required' => true,'id' => 'sec_state']) }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
...
<?php 
    $disability_details = "";
    if(isset($data['disability_details'])){
        $disability_details = $data['disability_details'];
    }
?>
                                                                <div class="form-group">
                                                                    <textarea name="disability_details" class="form-control" rows="4" placeholder="Please enter your details Of disability" required> {{ $disability_details }} </textarea>
                                                                </div>
    ...
    if(isset($data['criminal_record_details'])){
        $criminal_record_details = $data['criminal_record_details'];
    }
?>
                                                                <textarea name="criminal_record_details" class="form-control" rows="4" placeholder="Please enter your details Of criminal convictions" required>{{ $criminal_record_details }}</textarea>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund" value="selfFunded"
                                                                               {{ (('selfFunded'==$data['funds'])) ? 'checked': '' }} >
                                                                        <label> Self-Funded</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund"  value="parents"
                                                                                {{ (('parents' == $data['funds'])) ? 'checked': '' }}
                                                                        >
                                                                        <label> Parents</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund"  value="bankLoan"
                                                                                {{ (('bankLoan' == $data['funds'])) ? 'checked': '' }}
                                                                        >
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund"  value="employer"
                                                                                {{ (('employer' == $data['funds'])) ? 'checked': '' }}
                                                                        >
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund"  value="scholarship"
                                                                                {{ (('scholarship' == $data['funds'])) ? 'checked': '' }}>
                                                                        <label> Scholarship</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund" value="parentsInLaw"
                                                                                {{ (('parentsInLaw' == $data['funds'])) ? 'checked': '' }}>
                                                                        <label> Parents-In-Law</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <input type="radio" name="funds" class="fund"  value="otherRelative"
                                                                                {{ (('otherRelative' == $data['funds'])) ? 'checked': '' }}>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="visa_refused_family_div">
                                                            ...
                                                            <?php 
    $visa_refused_family_details = "";
    if(isset($data['visa_refused_family_details'])){
        $visa_refused_family_details = $data['visa_refused_family_details'];
    }
?>
                                                                <div class="form-group">
                                                                    <label>If yes, please provide details.</label>
                                                                    <textarea class="form-control" name="visa_refused_family_details" required=""> {{ $visa_refused_family_details }} </textarea> </div>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="overseas_studied_div">
                                                            @if($data['overseas_studied'] == 'yes')
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" name="overseas_studied_details" id="overseaStudyStatusDetails" required="">{{ $data['overseas_studied_details'] }}</textarea>
                                                                </div>
