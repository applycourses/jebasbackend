                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->status }}</td>
                                            <td>
                                                <a href="{{ url('agentstudent?view=application_view&application_id='.$value->application_id.'&student_id='.$value->student_id) }}" data-toggle="tooltip" title="View" class="btn btn-xs btn-primary">
                                                    <i class="fa fa-eye"></i>
                                                </a>
