                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                ...
                                <div class="tools">
                                    <a href="{{ URL('/agentstudent?view=account_details_edit&student_id=').app('request')->input('student_id') }}" class="edit"></a>
                                        ...
                                        <div class="col-md-6">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">                                                    
                                                        ...
                                                        <tr>
                                                            <th>Country</th>
                                                             <td>{{ get_country_name($data->country) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Email</th>
                                                              <td>{{ $data->email }}</td>
                                        ...
                                        <div class="col-md-6">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <th>State</th>
                                                              <td>{{ get_state_name($data->state) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Citizenship</th>
                                                            <td>{{ get_country_name($data->citizenship) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Gender</th>
                                                              <td>{{ $data->gender }}</td>
