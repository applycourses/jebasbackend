    ...
    <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li> <span class="active">Student List</span>
                    </li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"> <i class="fa fa-list"></i>Student List</div>
                                <div class="tools">
                                    <a href="{{ route('student-list.create') }}" class="addNew"></a>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach($students as $key => $value)
                                                ...
                                                @endif
                                                    ...
                                                    <td>{{ $value->dob }}</td>
                                                    <td>{{ $value->phone }}</td>
                                                    <td>{{ ($value->status == '0') ? 'Not Verified' : 'Verified' }}</td>
                                                    <td>{{ getStageNameBased($value->stage) }}</td>
                                                    <td> <a href="{{ url('student?view=account_details&student_id='.$value->id) }}"><i class="fa fa-eye view"></i></a></td>
                                                </tr>
                                        @endforeach    
                                        </tbody>
                                    </table>
