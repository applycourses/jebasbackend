        ...
        <div class="page-content">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                  {{ Form::model($statistics, array('route' => ['statistics.update', $statistics->id],'method' => 'put')) }}
                    <div class="clearfix">
                    ...
                    <div class="col-md-12">
                        <table class="table">
                            <tr>
                                ...
                                <th>Currency </th>
                                <td> {{ Form::select('currency', [''=> 'Please Select currency']+$currencies,null,['class' => 'form-control']) }}
                                </td>
                                <th>Total</th>
                                <td>{{ Form::text('total', null, array('class' => 'form-control','id'=> 'total')) }}</td>
                            </tr>
                        </table>
                    </div>
                    </div>
                    <table class="table">
                        ...
                        <tbody id="table-body">
                            @foreach(json_decode($statistics->details) as $key => $value)
                                <tr>
                                    <td>
                                        {{ Form::text('name',$value->name, array('class' => 'form-control','name'=> 'name[]')) }}
                                    </td>
                                    <td>
                                        {{ Form::text('name',$value->value, array('class' => 'form-control value','name'=> 'value[]')) }}
                                    </td>
                                    <td>
                                        <a title="Delete Product" class="btn btn-danger delete"> <i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
