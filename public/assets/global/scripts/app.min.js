    ...
    var t, e = !1,
        ...
        f = function() {
            $("body").on("click", ".portlet > .portlet-title > .tools > a.remove", function(t) {
                ...
                $("body").hasClass("page-portlet-fullscreen") && $("body").removeClass("page-portlet-fullscreen"), e.find(".portlet-title .fullscreen").tooltip("destroy"), e.find(".portlet-title > .tools > .reload").tooltip("destroy"), e.find(".portlet-title > .tools > .filter").tooltip("destroy"), e.find(".portlet-title > .tools > .remove").tooltip("destroy"), e.find(".portlet-title > .tools > .config").tooltip("destroy"), e.find(".portlet-title > .tools > .collapse, .portlet > .portlet-title > .tools > .expand").tooltip("destroy"), e.remove()
        ...
        w = function() {
            $(".tooltips").tooltip(), $(".portlet > .portlet-title .fullscreen").tooltip({
                ...
                container: "body",
                title: "Reload"
            }), $(".portlet > .portlet-title > .tools > .filter").tooltip({
                container: "body",
                title: "Filter"
            }), $(".portlet > .portlet-title > .tools > .addNew").tooltip({
                container: "body",
                title: "Add New"
            }), $(".portlet > .portlet-title > .tools > .trash").tooltip({
                container: "body",
                title: "Delete"
            }), $(".portlet > .portlet-title > .tools > .go_back").tooltip({
                container: "body",
                title: "Go Back"
